...
CampusX is a student-only social network where you need a verified college email to join. Real identity. Real campus community. No recruiters, no ads, no noise — just your college, your people, and your content.`,
    ...
    },
    {
        ...
        longDescription:
            "ScoutForge is a VC intelligence platform that helps investors and startups connect. It provides real-time market insights, funding trends, and investment opportunities.",
        tech: [
            "Next.js",
            "typescript",
            "tailwind css",
    ...
    },
    {
        ...
        longDescription:
            "Tare Chat is a real time chat application that helps users with their daily tasks. It provides real-time chat, voice call and secure environment for communication.",
    ...
    },
    {
        ...
        longDescription:
            "Stock Ease is a shop inventory web app that helps users with their daily tasks. It provides real-time inventory tracking, sales analytics, and customer management.",
    ...
    },
    {
        ...
        description:
            "Personal Dashboard for managing daily tasks and activities",
        longDescription:
            "Life Os is a personal dashboard that helps users manage their daily tasks and activities. It provides real-time task tracking, productivity analytics, and habit tracking.",
        tech: [
            "Next.js",
            "JavaScript",
            "Tailwind CSS",
    ...
    },
    {
        ...
        title: "Couple Vault 💕",
        description:
            "Secure shared space for couples to manage finances and activities",
        longDescription:
            "💖 A private, secure, and beautiful digital sanctuary for couples to preserve cherished memories. Features end-to-end vault protection, universal media support (images, videos, voice notes)",
        tech: [
            "Next.js",
            "JavaScript",
            "Tailwind CSS",
        ...
        year: "2026",
        link: "https://couple-vault.vercel.app/",
        sourceCode: "https://github.com/user-synax/couple-vault",
        image: "/projects/couple-vault.jpg",
    },
    {
        id: "7",
        number: "07",
...
📱 Fully Responsive: Optimized for seamless use across mobile, tablet, and desktop devices.`,
        ...
        year: "2026",
        link: "https://kitmint.vercel.app/",
        sourceCode: "https://github.com/user-synax/kitmint",
        image: "/projects/kitmint.jpg",
    },
];
...
const EXPERIENCE_CONFIG = [
    {
        company: "FCIT",
        role: "Full-Stack Teacher Internship",
        period: "2026 (3 months)",
        description:
            "Full-stack teacher internship at the institute, mentoring students and building practical projects.",
    },
];
                                                ...
                                                {selectedProject.tech.map(
                                                    (tech) => (
                                                        <Badge
                                                            key={tech}
                                                            variant="secondary"
                                                            className="font-['var(--font-dm-mono)'] text-xs"
                                                        >
                                                            {tech}
                                                        </Badge>
                                                    ),
                    ...
                    <div className="relative pl-8">
                        ...
                        <div className="mt-16 text-center">
                            <p className="font-['var(--font-dm-mono)'] text-sm text-neutral-500 mb-6">
                                Getting into this field — more experience coming
                                soon
                            </p>
