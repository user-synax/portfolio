...
CampusX is a student-only social network where you need a verified college email to join. Real identity. Real campus community. No recruiters, no ads, no noise — just your college, your people, and your content.`,
  ...
  },
  {
    ...
    number: "06",
    title: "Couple Vault 💕",
    description: "Secure shared space for couples to manage finances and activities",
    longDescription:
...
const EXPERIENCE_CONFIG = [
  {
    ...
    description:
      "Full-stack developer teacher internship at the institute, mentoring students and building practical projects.",
  },
];
